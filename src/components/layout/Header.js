...
const Header = () => {
  ...
  const{handleChange,values,handleSubmit, handleBlur,errors}=useForm(validateInfo);
          ...
          <div>
            <div className="row">
              <div className="input-field col s4">
                <input type="text" name="first_name" id="first_name" value={values.first_name} onChange={handleChange} onBlur={handleBlur} />
              ...
              <div className="input-field col s4">
                <input type="text" name="last_name" id="last_name" value={values.last_name} onChange={handleChange} onBlur={handleBlur} />
            ...
            <div className="row">
                ...
                <div className="input-field col s4 offsets12">
                    <input type="number" name="phone" id="phone" value={values.phone} onChange={handleChange} onBlur={handleBlur}/>
