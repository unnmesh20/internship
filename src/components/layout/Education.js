        ...
        <div className="education_details">
                ...
                <section>
                    ...
                    <form action="" className="col s12" onSubmit={handleSubmit}>
                        ...
                        <div className="input-field col s4 offset6">
                            <input type="text" name="percentage10" id="percentage10" value={values.percentage10} onChange={handleChange}/>
                    ...
                    <div className="row">
                        <div className="input-field col s4 ">
                            ...
                            <label htmlFor="ug" className="active">University Name</label>
                        </div>
                        <div className="input-field col s4 offset6">
